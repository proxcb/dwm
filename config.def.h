...
static const char *colors[][3]      = {
    ...
    [SchemeSel]  = { col_yellow, col_bg1, col_blue },
};
...
// Backlight
static const char *light_up[] = { "sh", "-c", "brightnessctl set +10%", NULL };
static const char *light_down[] = { "sh", "-c", "brightnessctl set 10%-", NULL };
